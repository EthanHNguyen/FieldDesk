...
async function main() {
  ...
  await page.screenshot({ path: "screenshots/03-evidence-map.png" });
  ...
  await page.screenshot({ path: "screenshots/04-surface-gaps.png" });
  ...
  await page.screenshot({ path: "screenshots/05-resolve-recompute.png" });
  ...
  await page.screenshot({ path: "screenshots/06-export-dts.png" });
